          ...
          >
            ...
            <div style={{ minWidth: 240 }}>
              ...
              <div style={{ fontSize: 14, color: "#475569" }}>
                â€¢ Speed: {prediction.speed} km/h
              </div>

              <div style={{ fontSize: 14, color: "#475569" }}>
                â€¢ Open Alerts: {prediction.openAlerts}
              </div>

              <div style={{ fontSize: 14, color: "#475569" }}>
                â€¢ Critical Alerts: {prediction.criticalAlerts}
              </div>
              ...
              <div style={{ fontSize: 14, color: "#475569" }}>
                â€¢ Offline: {prediction.isOffline ? "Yes" : "No"}
              </div>
            </div>
          </div>
        </div>
                    ...
                    <div style={{ marginTop: 14, display: "grid", gap: 8 }}>
                      {alerts.map((alert, index) => (
                        ...
                        >
                          ...
                          â€” {alert.message || "No alert message provided."}
                        </div>
                      ))}
                    </div>
                  ) : null}
