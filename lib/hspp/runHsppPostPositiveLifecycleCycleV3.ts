...
import {
  ...
  type RunHsppPostPositiveRevalidationUnsuitabilityAssessmentV2Result,
...
export const HSPP_POST_POSITIVE_LIFECYCLE_CYCLE_RUNNER_V3_VERSION =
  "hspp-post-positive-lifecycle-cycle-runner-v3" as const;
...
export type RunHsppPostPositiveLifecycleCycleV3Input = {
  supabase:
    SupabaseClient;
...
export type HsppPostPositiveLifecycleCycleV3ReevaluationResult =
  | {
      branch:
        "REEVALUATION_RESULT";
...
export type HsppPostPositiveLifecycleCycleV3CessationResult =
  | {
      branch:
        "CESSATION_RESULT";
...
export type HsppPostPositiveLifecycleCycleV3WorkResult =
  | HsppPostPositiveLifecycleCycleV3ReevaluationResult
  | HsppPostPositiveLifecycleCycleV3CessationResult;

export type HsppPostPositiveLifecycleCycleV3CursorAdvanceResult =
  | {
      branch:
...
export type RunHsppPostPositiveLifecycleCycleV3Result = {
  runnerVersion:
    typeof HSPP_POST_POSITIVE_LIFECYCLE_CYCLE_RUNNER_V3_VERSION;
  ...
  workResults:
    HsppPostPositiveLifecycleCycleV3WorkResult[];

  cursorAdvanceResult:
    HsppPostPositiveLifecycleCycleV3CursorAdvanceResult;
};

export type HsppPostPositiveLifecycleCycleV3Dependencies = {
  readWorkItems:
  ...
  runReevaluation:
    typeof runHsppPostPositiveRevalidationUnsuitabilityAssessmentV2;
 ...
 *   -> revalidation-aware Authority V2 runner
 *
 * CESSATION_REQUIRED:
 *
 *   caller-owned leaseToken
 ...
 */
export async function runHsppPostPositiveLifecycleCycleV3(
  {
    supabase,
    organizationId,
    limit,
...
): Promise<RunHsppPostPositiveLifecycleCycleV3Result> {
