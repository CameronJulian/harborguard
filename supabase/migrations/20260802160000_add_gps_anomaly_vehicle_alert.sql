...
on public.vehicle_alerts is
  'Allowed operational and telemetry alert types, including GPS anomaly, harsh braking, rapid acceleration, harsh cornering, speeding, and driver fatigue candidates.';
